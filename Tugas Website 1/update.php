...
<body>
    ...
    include "koneksi.php";
    $id = $_GET['id'];
    $penerbangan = mysqli_query($koneksi,"select * from input where id='$id'");
    ...
    <main class="page-main">
            <section class="form-section">
                <div class="form-container">
                    ...
                    <p class="form-sub">Update Data</p>
                    <form method="post" action="change.php">
                        <div class="form-group">
                            <label>Full name</label>
                            <input type="hidden" name="id" value="<?php echo $p['id']; ?>">
                            <input type="text" name="fullname" value="<?php echo $p['fullname'];?>" required>
                        </div>
                        <div class="form-group">
                            <label>Flight Code</label>
                            <input type="text" name="kd" value="<?php echo $p['kd'];?>"required>
                        </div>
                        <div class="form-group">
                            <label>Flight Date</label>
                            <input type="date" name="dt" value="<?php echo $p['dt'];?>"required>
                        </div>
                        <div class="form-group">
                            <label>City Of Origin</label>
                            <input type="text" name="origin" value="<?php echo $p['origin'];?>"required>
                        </div>
                        <div class="form-group">
                            <label>City Of Arrival</label>
                            <input type="text" name="arrival" value="<?php echo $p['arrival'];?>"required>
                        </div>
                        <div class="form-group">
                            <label>Flight Duration (hours)</label>
                            <input type="number" name="dur" min="0" step="0.2" value="<?php echo $p['dur'];?>"required>
                        </div>
                        <div class="form-group">
                            <label>Seat Number</label>
                            <input type="text" name="sn" value="<?php echo $p['sn'];?>"required>
                        </div>
                        <div class="form-group">
